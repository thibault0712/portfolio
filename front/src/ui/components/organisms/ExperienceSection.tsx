...
import ExperienceCard from "@/src/ui/components/molecules/ExperienceCard";
import TitleCard from "@/src/ui/components/molecules/TitleCard";
import {Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious} from "@/src/ui/components/atoms/shadcnUI/carousel";
...
const experiences: ExperienceEntry[] = [
    {
        ...
        role: "Baccalauréat en génie logiciel",
        years: "2026 - Présent",
        description: [
            "Échange international d'une année ou plus dans le cadre de mon BUT Informatique.",
            "Implication au sein de la vie étudiante et sportive (équipe de badminton Piranhas ÉTS)."
        ],
        technologies: ["Java"],
        isCompany: false
    },
                ...
                <Carousel aria-label="Mes expériences professionnelles et éducatives" className="w-full mx-auto">
                    <CarouselContent className={"mx-auto"}>
                        {experiences.map((exp, index) => (
                            <CarouselItem className={"p-2.5"} key={index}>
